...
export class MeshletCreator {
    ...
    public static async buildFromWasm(vertices: Float32Array, indices: Uint32Array):
        Promise<MeshletBuildOutput>
    {
    ...
    public static buildMeshletsFromBuildOutput(
        vertices: Float32Array, output: MeshletBuildOutput): Meshlet[]
    {
    ...
    public static async build(
        ...
        max_vertices: number, max_triangles: number)
    {
        const cone_weight = MeshletCreator.cone_weight
