...
import MeshOptimizerModule from "../../build/meshoptimizer"
...
export class MeshletBuilder {
    ...
    public static async build(
        vertices: Float32Array, indices: Uint32Array, max_vertices: number,
        max_triangles: number, cone_weight: number
    ): Promise<{
        ...
        return {
            ...
            meshlet_vertices_result: new Uint32Array(meshlet_vertices.data.buffer),
            meshlet_triangles_result: new Uint8Array(meshlet_triangles.data.buffer)
        }
    }
}
